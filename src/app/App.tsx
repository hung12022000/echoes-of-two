...
export function App() {
  ...
  const controls = <div className="control-grid"><span><kbd>Chuột / V</kbd> Nhìn / đổi góc nhìn</span><span><kbd>W A S D</kbd> Di chuyển</span><span><kbd>Shift</kbd> Chạy</span><span><kbd>Space</kbd> Nhảy</span><span><kbd>F</kbd> Kéo vật trôi / thu gom</span><span><kbd>C / I</kbd> Chế tạo / túi & kho</span><span><kbd>N / B</kbd> Xây dựng / đặt</span><span><kbd>G</kbd> Trồng trọt</span><span><kbd>M</kbd> Hải đồ & marker</span><span><kbd>J / Chuột trái</kbd> Tấn công</span><span><kbd>Q</kbd> Kỹ năng</span><span><kbd>E giữ</kbd> Cộng hưởng / cứu hộ</span><span><kbd>K</kbd> Vào hang boss</span><span><kbd>Esc</kbd> Tạm dừng</span></div>;
  ...
  if (screen === 'game') return <main className="game-shell">
    ...
    <div className="bottom-controls">Chuột nhìn · V đổi góc nhìn <b>·</b> WASD di chuyển <b>·</b> F kéo/nhặt <b>·</b> C chế tạo <b>·</b> G trồng cây <b>·</b> M hải đồ</div>
